...
<template>
  <div class="flex min-w-0 flex-col gap-2">
    <div class="rounded-xl bg-surface-raised shadow-ds-card p-2 sm:p-4">
      ...
      <textarea id="lyrics-editor" ref="taRef" v-model="lyricsText" rows="6"
        class="mt-2 w-full resize-y rounded-xl bg-surface-subtle/50 px-3 py-2 font-serif text-sm leading-relaxed text-content outline-none focus:border-brand focus:ring-2 focus:ring-brand/25"
