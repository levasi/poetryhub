...
<template>
  <div class="h-full" :class="{ 'col-span-2 row-span-2': featured && view !== 'list' }">
    <!-- List view -->
    ...
    <article v-else
      ...
      <div class="flex flex-1 flex-col" :class="featured ? 'p-6' : 'p-5'">
        ...
        <!-- Poem preview -->
        <p class="min-h-[4.5rem] flex-1 font-serif text-sm italic leading-relaxed text-content-secondary"
