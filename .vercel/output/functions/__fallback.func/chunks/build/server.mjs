...
import { hasInjectionContext, inject, toRef, isRef, computed, getCurrentInstance as getCurrentInstance$1, shallowRef, defineComponent, createElementBlock, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, createVNode, Text, mergeProps, withCtx, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, reactive, effectScope, nextTick, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { c as createError$1, I as parseURL, J as encodePath, K as decodePath, L as hasProtocol, M as isScriptProtocol, G as joinURL, N as withQuery, O as sanitizeStatusCode, P as getContext, $ as $fetch$1, Q as baseURL, R as defu, S as createHooks, V as executeAsync, W as getRequestURL, X as getRequestHeader, Y as getCookie, Z as klona, _ as destr, a0 as isEqual, a1 as createDefu, a2 as parsePath, a3 as parseQuery, a as setCookie, b as deleteCookie, a4 as withoutTrailingSlash } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "daily",
    path: "/daily",
    component: () => import('./daily-ctrMQK5X.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BHf6vc-P.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./login-Cr5puSYl.mjs')
  },
  {
    name: "search",
    path: "/search",
    component: () => import('./search-C--bEAmt.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    meta: __nuxt_page_meta$9 || {},
    component: () => import('./signup-XIYaC749.mjs')
  },
  {
    name: "favorites",
    path: "/favorites",
    component: () => import('./favorites-dAna0Jra.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-bp_mbANh.mjs')
  },
  {
    name: "admin-login",
    path: "/admin/login",
    meta: __nuxt_page_meta$7 || {},
    component: () => import('./login-B7kHdxZ7.mjs')
  },
  {
    name: "poems",
    path: "/poems",
    component: () => import('./index-B1nfOWIy.mjs')
  },
  {
    name: "admin-import",
    path: "/admin/import",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./import-CMJHnPY2.mjs')
  },
  {
    name: "poems-slug",
    path: "/poems/:slug()",
    component: () => import('./_slug_-BYldfdYy.mjs')
  },
  {
    name: "authors",
    path: "/authors",
    component: () => import('./index-C0dAZw26.mjs')
  },
  {
    name: "authors-slug",
    path: "/authors/:slug()",
    component: () => import('./_slug_-JzB5zJdo.mjs')
  },
  {
    name: "admin-poems-new",
    path: "/admin/poems/new",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./new-hs7ibvsN.mjs')
  },
  {
    name: "admin-authors-new",
    path: "/admin/authors/new",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./new-B8VP5M6K.mjs')
  },
  {
    name: "admin-poems",
    path: "/admin/poems",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-DXRlkO15.mjs')
  },
  {
    name: "admin-poems-slug",
    path: "/admin/poems/:slug()",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./_slug_-DSO80-wL.mjs')
  },
  {
    name: "admin-authors",
    path: "/admin/authors",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-Dg0i5w0B.mjs')
  },
  {
    name: "admin-authors-slug",
    path: "/admin/authors/:slug()",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./_slug_-BZXRJJ84.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-CiuiNuf1.mjs')
};
  ...
  ro: [
    {
      ...
      load: () => import(
        './ro-C2iUonp_.mjs'
        /* webpackChunkName: "locale_ro_46json_c6446c16" */
      ),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import(
        './en-DaJo-4ko.mjs'
        /* webpackChunkName: "locale_en_46json_7165bdf2" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/izB6AqBG"}/${locale}/messages.json`, { headers });
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/izB6AqBG"}/${locale}/messages.json`));
...
const layouts = {
  admin: defineAsyncComponent(() => import('./admin-DPZVMkww.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-DvwKSiNz.mjs').then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen w-full text-ink-900 antialiased" }, _attrs))}>`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DO8m1oDb.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C5Wvq-yG.mjs'));
...
export { useI18n as a, useSeoMeta as b, useRouter as c, useRoute as d, entry_default as default, createError as e, useState as f, encodeRoutePath as g, useNuxtApp as h, useRuntimeConfig as i, nuxtLinkDefaults as j, asyncDataDefaults as k, fetchDefaults as l, useRequestFetch as m, navigateTo as n, defineNuxtRouteMiddleware as o, resolveRouteObject as r, useHead as u };
